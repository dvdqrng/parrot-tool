      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <CheckCircle className="h-4 w-4 text-blue-500" strokeWidth={2} />
        ...
        <div className="flex items-center gap-2">
          <Brain className="h-4 w-4 text-muted-foreground" strokeWidth={2} />
          ...
          <div>
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              {summary.suggestedNextSteps.map((step, i) => (
                <li key={i} className="flex items-start gap-2">
                  <ArrowRight className="h-4 w-4 mt-1 text-blue-500" strokeWidth={2} />
                  <span>{step}</span>
                </li>
              ))}
            </ul>
