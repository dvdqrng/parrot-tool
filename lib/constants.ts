...
export const STORAGE_KEYS = {
  DRAFTS: 'beeper-kanban-drafts',
  SETTINGS: 'beeper-kanban-settings',
  MESSAGES: 'beeper-kanban-messages',
  ACCOUNTS: 'beeper-kanban-accounts',
  AVATARS: 'beeper-kanban-avatars',
  CHAT_INFO: 'beeper-kanban-chat-info',
  HIDDEN_CHATS: 'beeper-kanban-hidden-chats',
  HIDDEN_CHATS_META: 'beeper-kanban-hidden-chats-meta',
  TONE_SETTINGS: 'beeper-kanban-tone-settings',
  WRITING_STYLE: 'beeper-kanban-writing-style',
  AI_CHAT_HISTORY: 'beeper-kanban-ai-chat-history',
  USER_MESSAGES: 'beeper-kanban-user-messages',
  THREAD_CONTEXT: 'beeper-kanban-thread-context',
  AUTOPILOT_AGENTS: 'beeper-kanban-autopilot-agents',
  AUTOPILOT_CHAT_CONFIGS: 'beeper-kanban-autopilot-chat-configs',
  AUTOPILOT_ACTIVITY: 'beeper-kanban-autopilot-activity',
  AUTOPILOT_SCHEDULED: 'beeper-kanban-autopilot-scheduled',
  AUTOPILOT_HANDOFFS: 'beeper-kanban-autopilot-handoffs',
  CACHE_TIMESTAMP: 'beeper-kanban-cache-timestamp',
} as const;
