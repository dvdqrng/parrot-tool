 ...
 *
 * Ported from the main app's components/intelligence/ai-matrix-button.tsx
 * for use in the marketing website demos.
 */
...
export function AiMatrixButton({
  ...
  const resolutionRef = useRef<number>(60);
  ...
  // Update target uniforms when orbState changes
  useEffect(() => {
